...
class Books with ChangeNotifier {
  ...
  Future<void> fetchAndSetBooks([bool filterByUser = false]) async {
    ...
    var url =
        "https://phone-verification-b4161-default-rtdb.firebaseio.com/books.json";
    try {
  ...
  Future<void> updateBook(String id, Book newBook) async {
    ...
    if (bookIndex >= 0) {
      final url =
          'https://phone-verification-b4161-default-rtdb.firebaseio.com/books/$id.json';
      await http.patch(
        Uri.parse(url),
        body: json.encode({
          'title': newBook.title,
